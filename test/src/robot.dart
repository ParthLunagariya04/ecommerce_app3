...
class Robot {
  ...
  void expectFindAllProductCards() {
    ...
    //findsNWidgets use for locates the specified number of widgets in the widget tree.
  ...
  Future<void> openPopupMenu() async {
    ...
    // use this to tap on a wiidget only if it is found
    // useful with responsive apps
